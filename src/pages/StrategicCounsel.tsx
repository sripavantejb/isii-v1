      ...
      <section className="py-24 bg-background">
        <div className="container-custom section-padding">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6 animate-fade-in" style={{ willChange: "opacity, transform" }}>
            ...
            <p className="text-muted-foreground leading-relaxed animate-fade-in" style={{ willChange: "opacity, transform" }}>
